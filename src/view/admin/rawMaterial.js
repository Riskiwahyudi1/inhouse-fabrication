...
function ItemRequest() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const data = formData;
            const response = await api.post(`/api/admin/raw-material/add`, data,
                {
                    headers: {
    ...
    const handleEdit = async (e) => {
        ...
        try {
            ...
            const response = await api.put(`/api/admin/raw-material/edit`, data,
                {
                    headers: {
                        Authorization: `Bearer ${adminToken}`,
                    }
    ...
    const handleOpenModalEdit = (req) => {
        ...
        setFormDataEdit({ ...formDataEdit, id_raw_material: req })
                        ...
                        {listData?.length > 0 ? (
                            listData.map((data, idx) => (
                                <StyledTableRow key={idx}>
                                    ...
                                    <StyledTableCell>{data.raw_material_name}</StyledTableCell>
